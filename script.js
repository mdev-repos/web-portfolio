document.addEventListener("DOMContentLoaded", () => {
    ...
    const translations = {
        es: {
            ...
            "about-me": "Hola! mi nombre es matias y soy un desarrollador web backend en formacion. Utilizo Java y Spring, entre otras herramientas, para construir soluciones informaticas. Hechale un vistazo a mis proyectos!",
            "email-me": "Envíame un email",
            "stack": "Mi stack",
            "latest-projects": "Últimos Proyectos",
            "project-1-description": "<strong>Bazar API</strong> Es una API desarrollada con Java y Spring para gestionar un bazar. Fue construida como proyecto final en el marco del curso 'API's con Springboot' de TodoCode.",
        ...
        en: {
            ...
            "about-me": "Hi! My name is Matias and I am a backend web developer in training. I use Java and Spring, among other tools, to build IT solutions. Take a look at my projects!",
            "email-me": "Email me",
            "stack": "My stack",
